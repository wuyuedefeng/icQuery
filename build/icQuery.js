...
function createIcArray(arr) {
    ...
    /* #if icNote === 'exist' */
    _icArray.offsetParent.icDesc = '与当前元素最近的经过定位(position不等于static)的父级元素, 主要分为' + '【1】元素自身有fixed定位，offsetParent的结果为body' + '【2】元素自身无fixed定位，且父级元素都未经过定位，offsetParent的结果为body' + '【3】元素自身无fixed定位，且父级元素存在经过定位的元素，offsetParent的结果为离自身元素最近的经过定位的父级元素';
    /* #endif */
